...
enum {
	...
	FTSIODid = 0x8372,			/* Product Id SIO application of 8U100AX */
	...
	/*
	 *	An infrared receiver and transmitter using the
	 * 8U232AM chip 
	 ...
	 * ( http://www.intrepidcs.com/) ValueCAN and NeoVI
	 */
	INTREDidVid = 0x093C,
...
enum {
	FTSETDATAParNONE = (0x0 << 8),
	FTSETDATAParODD = (0x1 << 8),
	FTSETDATAParEVEN = (0x2 << 8),
	FTSETDATAParMARK = (0x3 << 8),
	FTSETDATAParSPACE = (0x4 << 8),
	FTSETDATASTOPBITS1 = (0x0 << 11),
	FTSETDATASTOPBITS15 = (0x1 << 11),
	FTSETDATASTOPBITS2 = (0x2 << 11),
	FTSETBREAK = (0x1 << 14),
};
